...
<div class="main-container">
    ...
    <div class="content">
        <div class="page-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0"><i class="fas fa-box-edit"></i> Editar Producto</h4>
                    ...
                    <form method="POST" action="index.php?controller=producto&action=edit&id=<?php echo $producto['id_producto']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="region_origen" name="region_origen" value="<?php echo $producto['region_origen']; ?>">
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="stock" name="stock" min="0" value="<?php echo $producto['stock']; ?>">
                            </div>
                        </div>
